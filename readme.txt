...
Installing "WP Traklight" can be done either by searching for "WP Traklight" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
